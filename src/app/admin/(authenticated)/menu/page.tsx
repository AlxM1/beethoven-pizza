  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="bg-[#FF6B6B] hover:bg-[#FF5252] text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors">
          <Plus size={20} />
          Add Item
        </button>
      </div>
                  ...
                  <div className="text-right">
                    {item.price ? (
                      ...
                      <div className="text-sm text-gray-500">
                        S: {formatCurrency(item.priceSmall || 0)} / M:{" "}
                        {formatCurrency(item.priceMedium || 0)} / L:{" "}
                        {formatCurrency(item.priceLarge || 0)}
                      </div>
                    )}
                  </div>
