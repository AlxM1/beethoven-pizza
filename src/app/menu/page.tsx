...
const menuData = {
  pizzaClassics: [
    {
      name: "Cheese Pizza",
      description: "Classic cheese pizza on our signature thick crust with premium mozzarella",
      small: "$17.00",
      medium: "$22.00",
      large: "$27.00",
    ...
    {
      name: "Canadian",
      description: "Pepperoni, Ham, Mushrooms, Bacon",
      small: "$21.00",
      medium: "$26.00",
      large: "$31.00",
      image: "/images/_MG_4475.jpg",
      popular: true,
    },
    {
      name: "Vegetarian",
      description: "Black Olives, Tomatoes, Green Peppers, Onions, Mushrooms",
      small: "$21.00",
      medium: "$26.00",
      large: "$31.00",
    ...
    {
      name: "Greek",
      description: "Spinach, Black Olives, Tomatoes, Green Peppers, Onions, Feta Cheese",
      small: "$21.00",
      medium: "$26.00",
      large: "$31.00",
      image: "/images/image6.JPG",
    ...
    {
      name: "Meat Lovers",
      description: "Pepperoni, Ham, Italian Sausage, Bacon, Ground Beef",
      small: "$22.00",
      medium: "$28.00",
      large: "$33.00",
    ...
    {
      name: "Spinach & Feta",
      description: "Fresh Spinach, Feta Cheese, Garlic, Tomatoes",
      small: "$21.00",
      medium: "$26.00",
      large: "$31.00",
      image: "/images/image6.JPG",
    ...
    {
      name: "BBQ Pork Ribs Pizza",
      description: "Boneless BBQ Pork Ribs, Onions, Green Peppers, Tomatoes",
      small: "$22.00",
      medium: "$28.00",
      large: "$33.00",
      image: "/images/_MG_4472.jpg",
    ...
    {
      name: "Najib's Special",
      description: "Beef, Pepperoni, Salami, Ham with Fresh Tomatoes & Feta Cheese added after baking",
      small: "$23.00",
      medium: "$29.00",
      large: "$34.00",
      image: "/images/Najib Special  3.jpg .jpg",
      signature: true,
    },
  ],
  buildYourOwn: {
  ...
  salads: [
    {
      name: "Greek Salad",
      description: "Cucumber, Tomatoes, Onions, Kalamata Olives, Feta Cheese - Served with garlic bread",
      small: "$8.00",
      large: "$15.00",
    ...
    {
      name: "Caesar Salad",
      description: "Crisp Romaine, Parmesan, Croutons, House-made Caesar Dressing - Served with garlic bread",
      small: "$7.00",
      large: "$13.00",
  ...
  pasta: [
    {
      name: "Baked Lasagna",
      description: "A classic baked lasagna - rich layers of pasta, savory meat sauce, and creamy cheese, baked to golden, bubbling perfection. Served with garlic bread.",
      price: "$17.00",
    },
    {
      name: "Spinach & Cheese Cannelloni",
      description: "Delicate pasta tubes filled with spinach and ricotta, topped with marinara sauce and melted cheese. Served with garlic bread.",
      price: "$17.00",
    },
    {
      name: "Spaghetti alla Bolognese",
      description: "Classic spaghetti topped with our tasty slow-cooked meat sauce. Served with garlic bread.",
      price: "$14.00",
    },
  ],
  comboDinners: [
    {
      name: "Lasagna Combo",
      description: "Baked Lasagna + Caesar or Greek Salad + Garlic Bread",
      price: "$22.00",
    },
    {
      name: "Cannelloni Combo",
      description: "Spinach & Cheese Cannelloni + Caesar or Greek Salad + Garlic Bread",
      price: "$22.00",
    },
    {
      name: "Spaghetti Combo",
      description: "Spaghetti alla Bolognese + Caesar or Greek Salad + Garlic Bread",
      price: "$19.00",
    },
    {
      name: "Wings Combo",
      description: "Chicken Wings (6) + Caesar or Greek Salad + Garlic Bread",
      price: "$18.00",
    },
  ],
  beverages: [
  ...
  extras: [
    ...
    { name: "Extra Ranch/Creamy Garlic/Cheddar Dressing", price: "$1.50" },
  ],
};
